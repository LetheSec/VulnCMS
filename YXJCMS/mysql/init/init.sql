...
GRANT ALL privileges on `yxjcms`.* to root@'%' identified by 'root' with grant option;
flush privileges;
...
INSERT INTO `yxj_adminlog` VALUES (31, 0, 1, '提示语:SQLSTATE[22003]: Numeric value out of range: 1690 BIGINT UNSIGNED value is out of range in \'(`yxj`.`yxj_category`.`items` - 1)\'', 1589777769, '127.0.0.1', '/cms/cms/delete/catid/5.html');
...
INSERT INTO `yxj_adminlog` VALUES (40, 0, 1, '提示语:SQLSTATE[22003]: Numeric value out of range: 1690 BIGINT UNSIGNED value is out of range in \'(`yxj`.`yxj_category`.`items` - 1)\'', 1589778232, '127.0.0.1', '/cms/cms/delete/catid/5.html?ids=2');
INSERT INTO `yxj_adminlog` VALUES (41, 0, 1, '提示语:SQLSTATE[22003]: Numeric value out of range: 1690 BIGINT UNSIGNED value is out of range in \'(`yxj`.`yxj_category`.`items` - 1)\'', 1589778252, '127.0.0.1', '/cms/cms/delete/catid/5.html?ids=1');
