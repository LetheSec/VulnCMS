...
class Index extends MemberBase
{
    ...
    public function dosign()
    {
        if ($this->request->isPost()) {
            ...
            if ($signin) {
                ...
                $score = isset($signdata['s' . $successions]) ? $signdata['s' . $successions] : $signdata['sn'];
                try {
                    SigninModel::create(['uid' => User::instance()->isLogin(), 'successions' => $successions, 'createtime' => time()]);
    ...
    public function fillup()
    {
        ...
        try {
            ...
            SigninModel::create(['uid' => User::instance()->isLogin(), 'type' => 'fillup', 'successions' => $successions, 'createtime' => $time + 43200]);
        } catch (Exception $e) {
