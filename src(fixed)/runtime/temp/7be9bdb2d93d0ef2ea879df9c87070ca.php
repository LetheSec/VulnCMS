<?php /*a:4:{s:49:"/var/www/application/joinus/view/index/index.html";i:1589781584;s:44:"/var/www/application/joinus/view/header.html";i:1589778124;s:43:"/var/www/application/joinus/view/sider.html";i:1589786384;s:44:"/var/www/application/joinus/view/footer.html";i:1589778730;}*/ ?>
...
<div class="main" style="position: relative;">
    <div class="w1200">
        <div class="container-top">
            ...
            <!--S 面包屑 -->
            <div class="bread-nav">
                <a href="">首页</a>&gt; <a href="/joinus/index/index">加入我们</a>
            </div>
            <!--E 面包屑 -->
        </div>
        <div class="content">
    ...
    <div class="menu-list">
        ...
        <a href="/about/index/index/?file=about.php" class="transition active">关于我们</a>
    ...
    <!--E 联系我们 -->
            ...
            <div class="content-right">
                <div class="content-contact">
                    <h1 align="center" style="font-size:35px;">提交简历</h1>
                </div>
                <br><br>
                <div>
                    <form action="/joinus/index/index" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            <label for="file">请上传您的简历</label>
                            <input type="file" id="file" name="file">
                            <p class="help-block">仅限上传docx文件</p>
                        </div>
                        <br>
                        <div>
                ...
                <br><br>
                <div>
                    <h1 style="font-size: 20px"><?php echo htmlentities($title); ?></h1>
                </div>
